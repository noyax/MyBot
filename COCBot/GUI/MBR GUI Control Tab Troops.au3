...
Func SetComboTroopComp()
	Switch _GUICtrlComboBox_GetCurSel($cmbTroopComp)
      ...
      GUICtrlSetState($cmbBarrack5, $GUI_DISABLE)
      GUICtrlSetState($cmbBarrack6, $GUI_DISABLE)
      ...
      GUICtrlSetState($cmbBarrack5, $GUI_ENABLE)
      GUICtrlSetState($cmbBarrack6, $GUI_ENABLE)      
